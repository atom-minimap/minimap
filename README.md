...
`Display Code Highlights`|If checked the code will be highlighted using the grammar tokens. (default=true) <p>With: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/with-code-highlights.png?raw=true)</p><p>Without: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/without-code-highlights.png?raw=true)</p>
`Display Minimap On Left`|If checked the Minimap appears on the left side of editors, otherwise it appears on the right side. (default=false) <p>On left: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/minimap-on-left.png?raw=true)</p><p>On Right: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/minimap-on-right.png?raw=true)</p>
`Char Height`|The height of a character in the Minimap in pixels. (default=2) <p>1px: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/1px-char-height.png?raw=true)</p><p>2px: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/2px-char-height.png?raw=true)</p><p>4px: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/4px-char-height.png?raw=true)</p>
`Char Width`|The width of a character in the Minimap in pixels. (default=1) <p>1px: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/1px-char-width.png?raw=true)</p><p>2px: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/2px-char-width.png?raw=true)</p>
`Interline`|The space between lines in the Minimap in pixels. (default=1) <p>1px: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/1px-interline.png?raw=true)</p><p>2px: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/2px-interline.png?raw=true)</p>
`Text Opacity`|The opacity used to render the line text in the Minimap. (default=0.6) <p>0.6: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/text-opacity-default.png?raw=true)</p><p>1: ![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/text-opacity-1.png?raw=true)</p>
`Display Plugins Controls`|If checked, the Minimap plugins can be activated/deactivated from the Minimap settings view and a quick settings dropdown will be available on the top right corner of the Minimap. **You need to restart Atom for this setting to be effective.**(default=true) <p>![](https://github.com/atom-minimap/minimap/blob/cn-better-documentation/resources/plugins-controls.png?raw=true)</p>
