...
* [How to create a minimap plugin?](http://fangduncai.com/atom-minimap/docs/Plugins.html)
* [Minimap's Decorations API](http://fangduncai.com/atom-minimap/docs/Decorations.html)
