...
export default class DOMStylesReader {
   ...
   */
  retrieveStyleFromDom (scopes, property, targetElement, cache = true) {
    ...
    this.ensureDummyNodeExistence(targetElement)
   ...
   * @access private
   */
  ensureDummyNodeExistence (targetElement) {
    ...
    targetElement.appendChild(this.dummyNode)
  }
