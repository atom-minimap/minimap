...
export default class CanvasDrawer extends Mixin {
  ...
  updateCanvas () {
    ...
    const intactRanges = this.computeIntactRanges(firstRow, lastRow)
  ...
  getInvisibleRegExp (line) {
    if ((line != null) && (line.invisibles != null)) {
      ...
      return RegExp(invisibles.filter((s) => typeof s === 'string')
  ...
  drawDecorations (screenRow, decorations, type, renderData, renderMethod) {
    const ref = decorations[type]
    decorations = ref != null ? ref[screenRow] : void 0
  ...
  truncateIntactRanges (intactRanges, firstRow, lastRow) {
    ...
    return intactRanges.sort((a, b) => a.offscreenRow - b.offscreenRow)
  }
}
