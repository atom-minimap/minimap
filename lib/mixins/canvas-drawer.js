...
export default class CanvasDrawer extends Mixin {
   ...
   *
   * @param  {CanvasRenderingContext2D} context the target canvas context
   * @param  {lineRange[]} intactRanges the intact ranges in the minimap
   ...
   * @param  {number} firstRow the first row of the rendered region
   * @param  {number} lastRow the last row of the rendered region
   * @return {lineRange[]} the intact ranges in the rendered region
   * @access private
   */
   ...
   * area of the minimap.
   *
   * @param  {lineRange[]} intactRanges the initial array of ranges
   * @param  {number} firstRow the first row of the rendered region
   * @param  {number} lastRow the last row of the rendered region
   * @return {lineRange[]} the array of truncated ranges
   */
