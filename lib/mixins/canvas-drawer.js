...
export default class CanvasDrawer extends Mixin {
  ...
  drawFrontDecorationsForLines (firstRow, lastRow, offsetRow) {
    ...
    this.renderedCustomDecorations = new WeakSet()
    ...
    delete this.renderedCustomDecorations
  ...
  drawCustomDecoration (decoration, data) {
    if (this.renderedCustomDecorations && this.renderedCustomDecorations.has(decoration)) {
      return
    }
    ...
    if (renderRoutine) {
      renderRoutine(data)
      this.renderedCustomDecorations.add(decoration)
    }
  }
