...
export default class CanvasDrawer extends Mixin {
  ...
  getDecorationColor(decoration) {
    ...
    if ((properties.color != null)) { return properties.color }
  ...
  drawLines(context, firstRow, lastRow, offsetRow) {
    ...
    for (var row = 0, line; row < lines.length; row++) {
      line = lines[row]
      var ref
      var ref1
      var ref2
      ...
      var x = 0
      var y = offsetRow + row
      var screenRow = firstRow + row
      var y0 = y*lineHeight

      // Line decorations are first drawn on the canvas.
      var lineDecorations = (((ref = decorations['line']) != null) ? ref[screenRow] : undefined)

      if ((typeof lineDecorations !== "undefined" && lineDecorations !== null) ? lineDecorations.length : undefined) { this.drawLineDecorations(context, lineDecorations, y0, canvasWidth, lineHeight) }

      // Then comes the highlight decoration with `highlight-under` type.
      var highlightDecorations = (((ref1 = decorations['highlight-under']) != null) ? ref1[firstRow + row] : undefined)
      if ((typeof highlightDecorations !== "undefined" && highlightDecorations !== null) ? highlightDecorations.length : undefined) {
        for (var i = 0, decoration; i < highlightDecorations.length; i++) {
          decoration = highlightDecorations[i]
      ...
      if ((((typeof line !== "undefined" && line !== null) ? line.tokens : undefined) != null)) {
        for (var j = 0, token; j < line.tokens.length; j++) {
          token = line.tokens[j]
          var w = token.screenDelta
          if (!token.isOnlyWhitespace()) {
            var color = (() => {
              if (displayCodeHighlights) {
                return this.getTokenColor(token)
              } else {
            ...
            if ((typeof invisibleRegExp !== "undefined" && invisibleRegExp !== null)) { value = value.replace(invisibleRegExp, ' ') }
      ...
      highlightDecorations = (((ref2 = decorations['highlight-over']) != null) ? ref2[firstRow + row] : undefined)
      if ((typeof highlightDecorations !== "undefined" && highlightDecorations !== null) ? highlightDecorations.length : undefined) {
        for (var k = 0, decoration; k < highlightDecorations.length; k++) {
      ...
      highlightDecorations = (((ref3 = decorations['highlight-outline']) != null) ? ref3[firstRow + row] : undefined)
      if ((typeof highlightDecorations !== "undefined" && highlightDecorations !== null) ? highlightDecorations.length : undefined) {
        for (var i1 = 0, decoration; i1 < highlightDecorations.length; i1++) {
          decoration = highlightDecorations[i1]
  ...
  getInvisibleRegExp(line) {
    if ((typeof line !== "undefined" && line !== null) && (line.invisibles != null)) {
      var invisibles = []
      ...
      return new RegExp(invisibles.filter((s) => { return typeof s === 'string'}).map(_.escapeRegExp).join('|'), 'g')
    }
  }
  ...
  drawToken(context, text, color, x, y, charWidth, charHeight) {
    ...
    var chars = 0
    for (var i = 0, char; i < text.length; i++) {
      char = text[i]
      if (/\s/.test(char)) {
        if (chars > 0) {
