...
export default class DecorationManagement extends Mixin {
  ...
  onDidAddDecoration (callback) {
    this.emitter.on('did-add-decoration', callback)
  }
  ...
  onDidRemoveDecoration (callback) {
    this.emitter.on('did-remove-decoration', callback)
  }
  ...
  onDidChangeDecoration (callback) {
    this.emitter.on('did-change-decoration', callback)
  }
  ...
  onDidUpdateDecoration (callback) {
    this.emitter.on('did-update-decoration', callback)
  }
