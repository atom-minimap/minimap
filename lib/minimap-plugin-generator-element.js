...
export default class MinimapPluginGeneratorElement extends HTMLElement {
  ...
  detach () {
    ...
    if (((ref = this.previouslyFocusedElement) != null)) { ref.focus() }
  ...
  confirm () {
    if (this.validPackagePath()) {
      ...
      this.createPackageFiles(() => {
        ...
        return setTimeout((() => this.detach()), 2000)
      })
    }
  }
